...
git clone --depth 1 https://github.com/kenzok8/small-package && mv -n small-package/{luci-app-luci-app-transmission,transmission-web-control,transmission,luci-app-gowebdav} ./ ; rm -rf small-package
